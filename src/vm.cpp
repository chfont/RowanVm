            ...
            switch (instr) {
                ...
                case Instruction::CJUMP: {
                    ...
                    switch (cond) {
                        ...
                        default:
                            std::cout << "ERROR: Condition invalid at byte " << cond_location << std::endl;
                            return;
                    }
                }
                ...
                case Instruction::STORE: {
                    auto a = program[programPointer++];
                    auto integer = getInt();
                    memcpy(memory.begin() + integer, reinterpret_cast<char *>(&(registers[a])), 4);
                    continue;
                }
                ...
                default:
                    std::cout << "ERROR: Invalid op code at " << programPointer-1 << std::endl;
                    return;
            }
        }
    }
